...
# Copyright (C) 2020 SebaUbuntu's TWRP device tree generato
#
...
#BOARD_RECOVERYIMAGE_PARTITION_SIZE := 8314880 # This is the maximum known partition size, but it can be higher, so we just omit it
